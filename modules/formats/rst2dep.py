...
Copy of https://github.com/amir-zeldes/gum/blob/dev/_build/utils/rst2dep.py
"""
...
def rst2dep(rstfile, xml_dep_root="", docname=None, out_mode="conll"):
